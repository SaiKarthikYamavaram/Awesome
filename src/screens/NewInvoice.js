...
const NewInvoice = () => {
    ...
    function updateNoOfParcels(increase: boolean) {
        if (increase) setnoOfParcels(noOfParcels + 1)
        else setnoOfParcels(Math.max(0, noOfParcels - 1))
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.containerStyle}>
            ...
            <Selector
                label={() => <Text style={[styles.labelStyle]}>Supplier</Text>}
            ...
            <Selector
                label={() => <Text style={[styles.labelStyle]}>Transporter</Text>}
            ...
            <Input
                ...
                value={invoiceNum}
                size="large"
                label={() => <Text style={[styles.labelStyle]}>Invoice number</Text>}
            ...
            <Input
                ...
                value={lrNum}
                label={() => <Text style={[styles.labelStyle]}>LR number</Text>}
                size="large"
                style={styles.inputStyle}
            ...
            <Datepicker
                ...
                label={() => <Text style={[styles.labelStyle]}>Invoice Receive date</Text>}
                size="large"
            ...
            <Datepicker
                ...
                style={styles.inputStyle}
                date={invoiceDate}
                label={() => <Text style={[styles.labelStyle]}>Invoice date</Text>}
                size="large"
            ...
            <Button size="large" style={styles.button} appearance='ghost'>
                {() => <Text
